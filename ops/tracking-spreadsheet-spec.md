...
| chef_name | Text | Customer name | Sydney Chef |
| chef_contact | Phone | Chef's mobile | +61412345678 |
| farmer_name | Text | Supplier name | Steve |
| farmer_contact | Phone | Farmer's mobile | +61487654321 |
| quantity | Number | Units ordered | 5 dozen |
| grade | Text | Quality grade | Grade A |
| pickup_location | Text | Farmer's location | Batemans Bay |
...
| depot_arrival_time | DateTime | Nowra depot arrival | 2026-06-20 09:30 |
| depot_status | Enum | received / pending / shipped | received |
| final_driver | Text | Sydney delivery driver | Jane Smith |
...
| cost_transport | Currency | Paid to Mustang | $25 |
...
- **at_depot**: Arrived at Nowra depot
- **out_for_delivery**: Final driver en route to Sydney
...
2406200001,2026-06-20,Sydney Chef,+61412345678,Steve,+61487654321,5 dozen,Grade A,Batemans Bay,2026-06-20 07:00,TRUE,John Doe,https://imgur.com/abc123,2026-06-20 09:30,received,Jane Smith,2026-06-20 14:00,TRUE,https://imgur.com/def456,None,$50,$25,$90,$15,delivered
```
...
Save as: `~/Documents/Agripals/ops/order-tracker.csv`  
